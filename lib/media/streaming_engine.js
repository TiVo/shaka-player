...
shaka.media.StreamingEngine = class {
  ...
  update_(mediaState) {
    ...
    // Use a reduced goal of 2 seconds during trick play since each SE
    // resync flushes the download.
    const trickPlayGoal = this.playerInterface_.isSeekBasedTrickPlayActive() ?
        2 : scaledBufferingGoal;
